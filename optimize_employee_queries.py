...
POSTGRES_USER = os.getenv("POSTGRES_USER", "pos_inventory")
POSTGRES_PASSWORD = os.getenv("POSTGRES_PASSWORD", "9491316460Aa!")
POSTGRES_HOST = os.getenv("POSTGRES_HOST", "localhost")
POSTGRES_PORT = os.getenv("POSTGRES_PORT", "5432")
POSTGRES_DB = os.getenv("POSTGRES_DB", "pos_inventory")
